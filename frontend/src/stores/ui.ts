...
/** Top-level view: the repo/PR workspace, the Activity (metrics + logs) page,
 * or the Live Review (background PR watcher) page. */
export const activeView = writable<'workspace' | 'activity' | 'live-review'>('workspace');
